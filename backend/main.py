...
from routers import (
    ...
    change_list, door_tags, meetings, office_hours, faculty_attributes, pdf_presets
)
...
app.include_router(faculty_attributes.router)
app.include_router(pdf_presets.router)
