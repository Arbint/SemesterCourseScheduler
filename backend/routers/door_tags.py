...
def door_tag_pdf(
    ...
    empty_font_scale = max(0.25, min(3.0, empty_font_scale))
    ...
    content = generate_door_tag_pdf(
        ...
        name_font_scale, semester_font_scale, time_font_scale, weekday_font_scale,
        header_offset_x_in, header_offset_y_in, footer_offset_x_in, footer_offset_y_in,
        empty_bg_color, empty_font_scale, empty_font_color,
